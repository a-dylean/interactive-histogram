...
export default function Dropdown() {
  return (
    <CustomSelect defaultValue={10}>
      <StyledOption value={10}>За последний год</StyledOption>
      <StyledOption value={20}>За последние 6 месяцев</StyledOption>
      <StyledOption value={20}>За последний месяц</StyledOption>
    </CustomSelect>
  );
}
